package javatry.enjoy.kinoshita;
 ...
 * @author kinoshita
 */
public class KinoshitaQ0StringTest extends ColorBoxTestCase {
    ...
    public void test_length_findMax() {
        ...
        for (ColorBox colorBox : colorBoxList) {
            ...
            for (BoxSpace boxSpace : spaceList) {
                ...
                if (((String)contents).length() > result.length()) {
    ...
    public void test_length_findMaxMinDiff() {
        ...
        for (ColorBox colorBox : colorBoxList) {
            ...
            for (BoxSpace boxSpace : spaceList) {
                ...
                if (((String)contents).length() > maxLength) {
                    maxLength = ((String)contents).length();
                }
                if (((String)contents).length() < minLength) {
                    minLength = ((String)contents).length();
                }
            }
        }
    ...
    public void test_length_findSecondMax_bySort() {
        ...
        for (ColorBox colorBox : colorBoxList) {
            ...
            for (BoxSpace boxSpace : spaceList) {
                String contents = boxSpace.toString();
                contentsList.add(contents);
            }
        }
        //contentsList.stream().sorted((x, y) -> ((String)x).length() - ((String)y).length());
        Collections.sort(contentsList, new Comparator<String>() {
                    @Override
