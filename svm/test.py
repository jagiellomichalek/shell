...
if __name__=='__main__':
    path_doc_root = '/home/wzswan/Downloads/fold0/corpus'
    path_tmp = '/home/wzswan/Downloads/fold0/tmp'
    path_files = '/home/wzswan/Downloads/fold0/testing'
    path_dictionary    = os.path.join(path_tmp, 'stock.dict')
    ...
    if not os.path.exists(path_tmp_tfidf):
        ...
        for i, msg in enumerate(demo_docs):
            if i%n == 0:
                ...
                if ('{x}'.format(x=catg_list[x[0]])) == "stock":
                   counter1 += 1
                   print counter1,counter2,i

                elif ('{x}'.format(x=catg_list[x[0]])) == "finance":
                   counter2 += 1
                   print counter1,counter2,i
